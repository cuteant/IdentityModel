...
namespace PCLCrypto
{
  ...
  internal class RsaAsymmetricKeyAlgorithmProvider : NCryptAsymmetricKeyProviderBase
  {
    ...
    /// <inheritdoc />
#if NET40
    protected internal override IDictionary<CryptographicPrivateKeyBlobType, string> NativePrivateKeyFormats => new Dictionary<CryptographicPrivateKeyBlobType, string>
#else
