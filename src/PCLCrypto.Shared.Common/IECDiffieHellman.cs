...
namespace PCLCrypto
{
    ...
    /// <summary>Provides functionality for the ECDiffieHellman algorithm.</summary>
    public interface IECDiffieHellman : IDisposable
    {
        ...
        /// <summary>Gets the public key to share with the other party in order to establish a shared secret.</summary>
