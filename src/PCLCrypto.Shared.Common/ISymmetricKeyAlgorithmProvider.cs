...
namespace PCLCrypto
{
  ...
  public interface ISymmetricKeyAlgorithmProvider
  {
    ...
    /// <summary>Gets the algorithm used in this algorithm.</summary>
    SymmetricAlgorithmName Name { get; }

    /// <summary>Gets the mode used in this algorithm.</summary>
    SymmetricAlgorithmMode Mode { get; }

    /// <summary>Gets the padding used in this algorithm.</summary>
