...
namespace PCLCrypto
{
    ...
    /// <summary>A factory for <see cref="IECDiffieHellmanPublicKey"/> instances.</summary>
    public interface IECDiffieHellmanCngPublicKeyFactory
    {
        /// <summary>Deserializes an <see cref="IECDiffieHellmanPublicKey"/> from a byte array.</summary>
