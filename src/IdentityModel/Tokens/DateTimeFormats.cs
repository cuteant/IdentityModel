...
{
    /// <summary>Represents DateTimeFormats used in tokens and claims</summary>
    public static class DateTimeFormats
    {
        /// <summary>Accepted DateTime formats</summary>
        ...
        /// <summary>Generated DateTime format</summary>
