...
namespace System.Security.Claims
{
    ...
    public class ClaimsPrincipal : IPrincipal
    {
        ...
        private void OnSerializingMethod(StreamingContext context)
        {
            ...
            if (_identities.Count > 0)
            {
                throw new PlatformNotSupportedException("This instance contains state that cannot be serialized and deserialized on this platform."); // BinaryFormatter and WindowsIdentity would be needed
            }
        }
