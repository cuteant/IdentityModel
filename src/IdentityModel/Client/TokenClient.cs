...
{
  /// <summary>Client for an OpenID Connect/OAuth 2.0 token endpoint</summary>
  ...
  public class TokenClient : IDisposable
  {
    ...
    /// <exception cref="System.ArgumentNullException">address or innerHttpMessageHandler</exception>
