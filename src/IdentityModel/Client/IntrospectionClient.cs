...
{
  /// <summary>Client for the OAuth 2.0 introspection endpoint</summary>
  public class IntrospectionClient
  {
    private readonly HttpClient _client;
    private readonly string _clientId;

    /// <summary>Initializes a new instance of the <see cref="IntrospectionClient"/> class.</summary>
