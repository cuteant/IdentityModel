...
{
  /// <summary>Client for an OpenID Connect userinfo endpoint</summary>
  public class UserInfoClient
  {
    ...
    /// <exception cref="System.ArgumentNullException">endpoint or innerHttpMessageHandler</exception>
    ...
    /// <summary>Sends the userinfo request.</summary>
