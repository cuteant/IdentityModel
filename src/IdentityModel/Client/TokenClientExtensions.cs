...
{
  /// <summary>Extensions for TokenClient</summary>
  public static class TokenClientExtensions
  {
    /// <summary>Requests a token based on client credentials.</summary>
    ...
    /// <summary>Requests a token using the resource owner password credentials.</summary>
    /// <param name="client">The client.</param>
    ...
    /// <summary>Requests a PoP token using an authorization code.</summary>
    /// <param name="client">The client.</param>
    /// <param name="code">The code.</param>
    /// <param name="redirectUri">The redirect URI.</param>
    /// <param name="codeVerifier">The code verifier.</param>
    ...
    /// <summary>Requests a token using a refresh token.</summary>
    /// <param name="client">The client.</param>
    ...
    /// <summary>Requests a PoP token using a refresh token.</summary>
    /// <param name="client">The client.</param>
    /// <param name="refreshToken">The refresh token.</param>
    /// <param name="algorithm">The algorithm.</param>
    /// <param name="key">The key.</param>
    ...
    /// <summary>Requests a token using a an assertion.</summary>
    /// <param name="client">The client.</param>
