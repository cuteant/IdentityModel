...
{
    /// <summary>Extensions for JObject</summary>
    public static class JObjectExtensions
    {
        /// <summary>Converts a JSON claims object to a list of Claim</summary>
        ...
        /// <summary>Tries to get a value from a JObject</summary>
        /// <param name="json">The json.</param>
        ...
        /// <summary>Tries to get an int from a JObject</summary>
        /// <param name="json">The json.</param>
        /// <param name="name">The name.</param>
        /// <returns></returns>
        ...
        /// <summary>Tries to get a string from a JObject</summary>
        /// <param name="json">The json.</param>
        /// <param name="name">The name.</param>
        /// <returns></returns>
        ...
        /// <summary>Tries to get a boolean from a JObject</summary>
        /// <param name="json">The json.</param>
        /// <param name="name">The name.</param>
        /// <returns></returns>
        ...
        /// <summary>Tries to get a string array from a JObject</summary>
        /// <param name="json">The json.</param>
        /// <param name="name">The name.</param>
        /// <returns></returns>
