...
{
    /// <summary>A protocol response</summary>
    public abstract class Response
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="Response"/> class with an exception.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="Response"/> class with an HTTP status code.</summary>
        ...
        /// <summary>Gets the raw protocol response.</summary>
        /// <value>The raw.</value>
        public string Raw { get; }

        /// <summary>Gets the protocol response as JSON.</summary>
        ...
        /// <summary>Gets the HTTP error reason.</summary>
        /// <value>The HTTP error reason.</value>
        ...
        /// <summary>Tries to get a specific value from the JSON response.</summary>
