...
{
    /// <summary>Models the response from an OpenID Connect discovery endpoint</summary>
    public class DiscoveryResponse
    {
        ...
        /// <summary>Gets the response as a JObject.</summary>
        ...
        /// <summary>Gets or sets the JSON web key set.</summary>
        /// <value>The key set.</value>
        public JsonWebKeySet KeySet { get; set; }

        /// <summary>Initializes a new instance of the <see cref="DiscoveryResponse"/> class.</summary>
        ...
        /// <summary>Checks if the issuer matches the authority.</summary>
        ...
        /// <summary>Validates the endoints and jwks_uri according to the security policy.</summary>
