...
{
    /// <summary>Client for the OpenID Connect dynamic client registration endpoint</summary>
    ...
    public class DynamicRegistrationClient : IDisposable
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="DynamicRegistrationClient"/> class.</summary>
        ...
        /// <summary>Send a registration message to the endpoint.</summary>
