...
namespace PCLCrypto
{
    ...
    {
        /// <summary>The algorithm to use when deriving a cryptographic key.</summary>
        private readonly KeyDerivationAlgorithm algorithm;

        /// <summary>The key material.</summary>
        private readonly byte[] key;

        /// <summary>Initializes a new instance of the <see cref="KeyDerivationCryptographicKey"/> class.</summary>
        ...
        /// <summary>Gets the algorithm to use when deriving a cryptographic key.</summary>
