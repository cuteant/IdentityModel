...
{
  /// <summary>Configuration options for the OidcClient</summary>
  public class OidcClientOptions
  {
    ...
    /// <summary>Gets the web view implementation.</summary>
    /// <value>The web view.</value>
    public IWebView WebView { get; }

    /// <summary>Gets the identity token validator.</summary>
    /// <value>The identity token validator.</value>
    public IIdentityTokenValidator IdentityTokenValidator { get; }

    /// <summary>Gets or sets a value indicating whether a form post is used in the authorize response.</summary>
    /// <value> <c>true</c> if form_post is used; otherwise, <c>false</c>.</value>
    public bool UseFormPost { get; set; } = false;

    /// <summary>Gets or sets a value indicating whether the userinfo endpoint is used to load user claims</summary>
    /// <value> <c>true</c> if the profile is loaded; otherwise, <c>false</c>.</value>
    public bool LoadProfile { get; set; } = true;

    /// <summary>Gets or sets a value indicating whether claims should be filtered.</summary>
    /// <value> <c>true</c> if claims will be fitered; otherwise, <c>false</c>.</value>
    public bool FilterClaims { get; set; } = true;

    /// <summary>Gets or sets a value indicating whether the issuer name is validated to make sure matches the authority.</summary>
    /// <value> <c>true</c> if issuer name gets validated; otherwise, <c>false</c>.</value>
    public bool ValidateIssuerName { get; set; } = true;

    /// <summary>Gets or sets the authentication style (basic authorization code vs hybrid).</summary>
    /// <value>The style.</value>
    public AuthenticationStyle Style { get; set; } = AuthenticationStyle.Hybrid;

    /// <summary>Gets or sets the web view timeout.</summary>
    /// <value>The web view timeout.</value>
    public TimeSpan WebViewTimeout { get; set; } = TimeSpan.FromSeconds(10);

    /// <summary>Gets or sets the token client authentication style.</summary>
    ...
    /// <summary>Gets or sets the backchannel handler.</summary>
    /// <value>The backchannel handler.</value>
    public HttpMessageHandler BackchannelHandler { get; set; }

    /// <summary>Gets or sets the claims filter.</summary>
    ...
    /// <summary>Initializes a new instance of the <see cref="OidcClientOptions"/> class.</summary>
...
#if NET40
      _providerInfo = new Lazy<Task<ProviderInformation>>(() => TaskEx.FromResult(info));
#else
    ...
    /// <summary>The authentication style</summary>
