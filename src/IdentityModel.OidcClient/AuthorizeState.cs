...
{
  /// <summary>Represents the state the needs to be hold between starting the authorize request and the response</summary>
  public class AuthorizeState
  {
    ...
    /// <summary>Gets or sets the code verifier.</summary>
