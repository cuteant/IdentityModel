...
namespace PCLCrypto.Formatters
{
    ...
    /// <summary>Encodes/decodes ASN.1 messages.</summary>
    /// <remarks>
    ...
    {
        /// <summary>The BER encoding Class of a data element.</summary>
        internal enum BerClass : byte
        {
            /// <summary>The type is native to ASN.1</summary>
            Universal = 0x00,

            /// <summary>The type is only valid for one specific application</summary>
            Application = 0x40,

            /// <summary>Meaning of this type depends on the context (such as within a sequence, set or choice)</summary>
            ContextSpecific = 0x80,

            /// <summary>Defined in private specifications</summary>
            Private = 0xC0,

            /// <summary>The set of bits that describe the class.</summary>
            Mask = 0xC0,
        }

        /// <summary>The BER encoding PC (primitive or constructed) of a data element.</summary>
        internal enum BerPC : byte
        {
            /// <summary>The content is primitive like an <see cref="BerTag.Integer"/>.</summary>
            Primitive = 0x00,

            /// <summary>The content holds type-length-value values like a <see cref="BerTag.Sequence"/>.</summary>
            Constructed = 0x20,

            /// <summary>The set of bits that describe the PC.</summary>
            Mask = 0x20,
        }

        /// <summary>The BER encoding Tag of a data element.</summary>
        internal enum BerTag : byte
        {
            /// <summary>Indicates that this is the end of the stream.</summary>
            EndOfContent = 0x0,

            /// <summary>Indicates that <see cref="DataElement.Content"/> is an integer.</summary>
            Integer = 0x2,

            /// <summary>Indicates that <see cref="DataElement.Content"/> is a bit string.</summary>
            BitString = 0x3,

            /// <summary>Indicates that <see cref="DataElement.Content"/> is an octet string.</summary>
            OctetString = 0x4,

            /// <summary>Indicates that <see cref="DataElement.Content"/> is null.</summary>
            Null = 0x5,

            /// <summary>Indicates that <see cref="DataElement.Content"/> is an object identifier.</summary>
            ObjectIdentifier = 0x6,

            /// <summary>Indicates that <see cref="DataElement.Content"/> is a sequence.</summary>
            Sequence = 0x10,

            /// <summary>Indicates that <see cref="DataElement.Content"/> is a set and set of.</summary>
            SetAndSetOf = 0x11,

            /// <summary>The set of bits that describe the tag.</summary>
            Mask = 0x1F,
        }

        /// <summary>Reads a sequence of ASN.1 elements from a stream.</summary>
        ...
        /// <summary>Writes a single ASN.1 element to a stream.</summary>
        /// <param name="stream">The stream.</param>
        ...
        /// <summary>Returns a buffer containing an encoded ASN.1 element.</summary>
        /// <param name="element">The data element.</param>
        ...
        /// <summary>Returns a buffer containing encoded ASN.1 elements.</summary>
        ...
        /// <summary>Gets the minimum number of bytes required to represent an unsigned integer.</summary>
        ...
        /// <summary>Describes an individual ASN.1 element.</summary>
        internal struct DataElement
        {
            /// <summary>Initializes a new instance of the <see cref="DataElement"/> struct.</summary>
