...
namespace CuteAnt.IdentityModel.OidcClient
{
    ...
    public class OidcClient
    {
        ...
        {
            if(_logger.IsTraceLevelEnabled()) _logger.LogTrace("LoginAsync");
        ...
        {
            if(_logger.IsTraceLevelEnabled()) _logger.LogTrace("PrepareLoginAsync");
        ...
        {
            if(_logger.IsTraceLevelEnabled()) _logger.LogTrace("GetUserInfoAsync");
        ...
        {
            if(_logger.IsTraceLevelEnabled()) _logger.LogTrace("RefreshTokenAsync");
        ...
        {
            if(_logger.IsTraceLevelEnabled()) _logger.LogTrace("EnsureProviderInformation");
        ...
        {
            if(_logger.IsTraceLevelEnabled()) _logger.LogTrace("ProcessClaims");
