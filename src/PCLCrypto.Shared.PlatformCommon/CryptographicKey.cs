...
namespace PCLCrypto
{
    ...
    /// <summary>Base class for implementations of the <see cref="ICryptographicKey"/> interface.</summary>
    internal abstract class CryptographicKey : IDisposable
    {
        /// <summary>Gets the hash algorithm to use for signatures. May be null.</summary>
        protected virtual IHashAlgorithmProvider SignatureHashAlgorithm
        {
            get { throw new NotSupportedException(); }
        }

        /// <summary>Gets the hash algorithm to use for signatures, or throws an exception if null.</summary>
        ...
        /// <summary>Disposes managed and native resources associated with this instance.</summary>
        public void Dispose()
        {
            this.Dispose(true);
        ...
        /// <summary>Signs data with this key.</summary>
        ...
        /// <summary>Verifies the signature of data with this key.</summary>
        /// <param name="data">The data.</param>
        ...
        /// <summary>Verifies the signature of a hash of data with this key.</summary>
        /// <param name="data">The hash of the data.</param>
        /// <param name="signature">The signature.</param>
        /// <returns><c>true</c> if the signature is valid.</returns>
        ...
        /// <summary>Decrypts the specified data.</summary>
        ...
        /// <summary>Creates a crypto transform to encrypt a stream.</summary>
        /// <param name="iv">The initialization vector. Should be <c>null</c> for asymmetric algorithms.</param>
        /// <returns>The ciphertext.</returns>
        ...
        /// <summary>Creates a crypto transform to decrypt a stream.</summary>
        /// <param name="iv">The initialization vector. Should be <c>null</c> for asymmetric algorithms.</param>
        /// <returns>The plaintext.</returns>
