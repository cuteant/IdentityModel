...
namespace PCLCrypto
{
    ...
    /// <summary>A .NET implementation of the <see cref="IECDiffieHellmanPublicKey"/> interface.</summary>
    internal class ECDiffieHellmanPublicKey : IECDiffieHellmanPublicKey
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="ECDiffieHellmanPublicKey"/> class.</summary>
        ...
        /// <summary>Gets the platform-defined public key.</summary>
